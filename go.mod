...
require (
	...
	github.com/openbao/go-kms-wrapping/kms/transit/v2 v2.0.0-20260728185732-515b83b72819
	github.com/openbao/go-kms-wrapping/plugin/v2 v2.3.1-0.20260728185732-515b83b72819
	github.com/openbao/go-kms-wrapping/v2 v2.8.1-0.20260728185732-515b83b72819
